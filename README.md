...
- `arctic_sd_16k_world_features.wav`: Generated by SD WNV with `egs/arctic/sd` recipe
- `arctic_si-close_16k_world_features.wav`: Generated by SI-CLOSE WNV with `egs/arctic/si-close` recipe
- `arctic_si-open_16k_world_features.wav`: Generated by SI-OPEN WNV with `egs/arctic/si-open` recipe
- `ljspeech_raw_22.05k.wav`: Original in LJSpeech database
- `ljspeech_sd_22.05k_world_features.wav`: Generated by SD WNV with `egs/ljspeech/sd` recipe

The samples of WNV with Mel-spectrogram will be available soon!
